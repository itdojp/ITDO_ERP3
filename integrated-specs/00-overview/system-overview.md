...
| 原則 | 説明 | 実装方針 |
|------|------|----------|
| **クラウドネイティブ** | クラウド最適化設計 | AWS東京リージョン、マネージドサービス活用 |
...
gantt
    ...
    section Phase1 MVP
    基盤構築           :2025-01-01, 60d
    PM基本機能         :2025-02-01, 60d
    FI基本機能         :2025-02-15, 75d
    契約管理           :2025-03-01, 45d
    会計連携           :2025-04-01, 30d
    MVP完了            :milestone, 2025-06-30, 0d
